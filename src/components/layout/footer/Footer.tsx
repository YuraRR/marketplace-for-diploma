...
export default function Footer() {
  return (
    <footer className="w-full px-8 pt-8 pb-4 mt-4 bg-white rounded-lg ">
        ...
        <div>
          ...
          <div className="flex mt-4 space-x-3">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faTwitter} className="p-3 bg-gray-300 rounded-full" />
            </a>
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faFacebookF} className="p-3 bg-gray-300 rounded-full" />
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faInstagram} className="p-3 bg-gray-300 rounded-full" />
            </a>
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faYoutube} className="p-3 bg-gray-300 rounded-full" />
            </a>
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faPinterest} className="p-3 bg-gray-300 rounded-full" />
            </a>
          </div>
        </div>
